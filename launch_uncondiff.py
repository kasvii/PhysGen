...
from uncond_diffusion.utils import get_config_from_file, instantiate_from_config
...
import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), 'uncond_diffusion'))
